...
import { DestacadoColumn } from "./columns";
...
export const CellAction: React.FC<CellActionProps> = ({
    ...
    const onConfirm = async ()=>{
        try{
            setLoading(true)
            await axios.delete(`/api/${params.storeId}/destacados/${data.id}`);
        ...
        <>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={()=>router.push(`/${params.storeId}/destacados/${data.id}`)}>
